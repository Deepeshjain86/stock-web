...
//     try {
//       let res;
//       if (txForm.type === 'Borrow') {
//         const payload = {
//           customer_id: selectedCustomer.id,
//           total_amount: Number(txForm.amount),
//           borrow_date: txForm.date,
//           due_date: new Date(new Date(txForm.date).getTime() + 15 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
//           remarks: txForm.notes || ''
//         };
//         res = await API.post('/borrow/transactions', payload);
//       } else {
//         const payload = {
//           customer_id: selectedCustomer.id,
...
//           remarks: txForm.notes || ''
//         };
//         res = await API.post('/borrow/payback', payload);
//       }
...
//                           >
//                             <PlusIcon className="w-3.5 h-3.5 stroke-[2.5]" /> Record
//                           </button>
//                         )}
//                         <button
...
//                 <div>
//                   <h3 className="text-sm font-bold uppercase tracking-wider">Record credit entry</h3>
...
//                     <button
//                       type="button"
//                       onClick={() => setTxForm({...txForm, type: 'Payback'})}
//                       className={`py-2 rounded-xl text-xs font-bold border transition-all ${
//                         txForm.type === 'Payback' 
...
//                   <textarea
//                     rows="2"
//                     placeholder="Enter items details or reference..."
//                     value={txForm.notes}
